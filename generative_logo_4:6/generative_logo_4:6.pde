...
void setup(){
  ...
  beginRecord(PDF, "generative-logo4.pdf");
...
//The ellipse with posX, posY and width and height of 300 pixels:
    ...
    /*beginShape(); //Quarter moon left
      vertex(300+randomX, 150+randomY);
      bezierVertex(75+randomX, 100+randomY, 75+randomX, 525+randomY, 300+randomX, 450+randomY);
      bezierVertex(300+randomX, 450+randomY, 150+randomX, 300+randomY, 300+randomX, 150+randomY);
    endShape();*/
    
    /*beginShape(); //Quarter moon right
      vertex(300+randomX, 150+randomY);
      bezierVertex(525+randomX, 100+randomY, 525+randomX, 525+randomY, 300+randomX, 450+randomY);
      bezierVertex(300+randomX, 450+randomY, 450+randomX, 300+randomY, 300+randomX, 150+randomY);
    endShape();*/
